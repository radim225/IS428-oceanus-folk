...
![Sailor Shift's Collaborations Over Time, Genre Influences, and Direct & Indirect Influence — three-chart Tableau dashboard overview](images/task1/task1_Sailor_shift_Collab.png){width=100%}
...
![Oceanus Folk Production in Sailor Shift's Circle Over Time (left) and Top Oceanus Folk Contributors in Sailor's Circle After 2028 (right)](images/task1/task1_Sailor_impact_OF.png){width=100%}
